...
namespace Data
{
    public class CommentDat
    {
       ...
       //Metodo para eliminar un producto
        public bool deleteComment(int _idComment)
        {
            ...
            // Se crea un comando MySQL para eliminar un comentario utilizando un procedimiento almacenado.
            MySqlCommand objSelectCmd = new MySqlCommand();
            objSelectCmd.Connection = objPer.openConnection();
            objSelectCmd.CommandText = "spDeleteComment"; // nombre del procedimiento almacenado
            objSelectCmd.CommandType = CommandType.StoredProcedure;

            // Se agrega un parámetro al comando para pasar el ID del comentario que se desea eliminar.
            objSelectCmd.Parameters.Add("p_idComment", MySqlDbType.Int32).Value = _idComment;
    ...
    public DataSet procShowCommentsDDL()
    {
        ...
        MySqlCommand objSelectCmd = new MySqlCommand();
        objSelectCmd.Connection = objPer.openConnection();
        objSelectCmd.CommandText = "procShowCommentsDDL";
        objSelectCmd.CommandType = CommandType.StoredProcedure;
        objAdapter.SelectCommand = objSelectCmd;
        objAdapter.Fill(objData);
        objPer.closeConnection();
